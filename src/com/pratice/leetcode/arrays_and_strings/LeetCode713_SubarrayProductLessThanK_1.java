...
public class LeetCode713_SubarrayProductLessThanK_1 {
...
//        System.out.println(LeetCode713_SubarrayProductLessThanK_1.numSubarrayProductLessThanK(new int[]{10, 9, 10, 4, 3, 8, 3, 3, 6, 2, 10, 10, 9, 3}, 19));
        System.out.println(LeetCode713_SubarrayProductLessThanK_1.numSubarrayProductLessThanK(new int[]{57, 44, 92, 28, 66, 60, 37, 33, 52, 38, 29, 76, 8, 75, 22}, 18));
        System.out.println();
    }
}
